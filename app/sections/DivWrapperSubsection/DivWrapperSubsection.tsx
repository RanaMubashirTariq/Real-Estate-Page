  ...
  return (
    <section className="w-full h-[1050px] max-[1000px]:h-[850px] max-[600px]:h-[700px] max-[500px]:h-[750px] relative bg-cover bg-[50%_50%]">
        ...
        <motion.div 
                  ...
                  whileTap={{scale:0.9}}
                  className="inline-flex items-center justify-center absolute top-[880px] max-[1000px]:top-[760px] max-[767px]:top-[580px] max-[500px]:top-[650px] max-[500px]:right-[130px] max-[400px]:right-[100px] right-[900px]  max-[1500px]:right-[617px] max-[1300px]:right-[550px] max-[1100px]:right-[400px] max-[900px]:right-[350px] max-[800px]:right-[300px] max-[600px]:right-[200px] max-[530px]:right-[170px] max-[350px]:right-[70px]"
          >
      ...
      <div className="absolute w-[1246px] h-[700px] top-[120px] max-[1000px]:top-[60px] max-[767px]:top-10 left-[150px]  max-[1500px]:left-[100px] max-[1100px]:left-[50px] max-[767px]:left-[25px]">
        <div className="flex flex-col min-[1500px]:w-[1100px] w-[900px] max-[500px]:w-[400px] items-start gap-[49px] absolute top-0 left-0  max-[500px]:pr-[25px]">
          <h2 className="relative self-stretch  font-THICCCBOI font-bold text-neutral-800 text-[70px] max-[1100px]:text-[54px] max-[767px]:text-[42px] max-[500px]:text-center max-[500px]:text-[36px]  tracking-[0] leading-[normal] max-[500px]:mr-[50px] max-[340px]:mr-[100px]">
        ...
        <Card className="absolute w-[586px] h-[402px] max-[500px]:w-[300px] max-[500px]:h-[350px] max-[767px]:h-[260px] max-[1000px]:w-[480px] top-[214px] min-[1500px]:right-[-150px] right-[100px] max-[1300px]:right-[150px] max-[1100px]:right-[300px] max-[1000px]:right-[400px]  max-[900px]:right-[500px] max-[800px]:right-[550px] max-[600px]:right-[750px] max-[530px]:right-[770px] max-[500px]:right-[900px] max-[365px]:right-[940px] max-[330px]:right-[960px] border-none">
