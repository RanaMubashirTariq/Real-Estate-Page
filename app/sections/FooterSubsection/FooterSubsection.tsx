    ...
    <footer className="relative w-full h-auto bg-neutral-800 mt-[140px] max-[1100px]:mt-[100px] max-[1000px]:mt-[60px] max-[767px]:mt-10">
      <div className="relative w-full h-[656px] max-[1100px]:h-[620px] max-[900px]:h-auto">
        ...
        <div className="w-full flex flex-col items-start gap-6 relative">
               ...
               <div className="w-[338px] max-[1100px]:w-[270px] max-[767px]:w-[100%]  opacity-70 font-THICCCBOI font-regular text-lg max-[1100px]:text-[16px] max-[1100px]:leading-[28px] max-[767px]:text-sm max-[767px]:leading-[26px] leading-[30px] text-white tracking-[0]">
               ...
               <div className="flex items-start gap-[100px] max-[1100px]:gap-10 max-[900px]:w-full max-[500px]:flex-wrap">
                 <div className="flex flex-col items-start gap-10 max-[767px]:gap-5">
                   <div className="font-THICCCBOI font-bold text-xl max-[1100px]:text-[20px] max-[767px]:text-lg max-[767px]:leading-[20px]  leading-[22px] text-white tracking-[0]">
                     Footer Menu
                   </div>
                   ...
                   <div className="flex flex-col items-start gap-6 max-[767px]:gap-4">
                    {footerMenuColumn1.map((item, index) => (
                      <Link
                        key={index}
                        href={item.id}
                        className="opacity-70 font-THICCCBOI font-regular text-white text-lg 
                     ...
                     <div className="flex flex-col items-start gap-6 max-[767px]:gap-4">
                       {footerMenuColumn2.map((item, index) => (
                         <div
                           key={index}
                           className="opacity-70 font-THICCCBOI font-regular text-white text-lg max-[1100px]:text-[16px] max-[767px]:text-sm max-[767px]:leading-[18px] text-center tracking-[0] leading-5 whitespace-nowrap cursor-pointer hover:opacity-100 transition-opacity"
                         >
                           {item}
                         </div>
                       ))}
                 ...
                 <div className="flex flex-col items-start gap-10 max-[767px]:gap-5">
                   <div className="font-THICCCBOI font-bold text-xl max-[1100px]:text-[18px] leading-[22px] max-[767px]:text-base max-[767px]:leading-[20px] text-white tracking-[0]">
                     Follow us
                   </div>
                   ...
                   <div className="flex flex-col items-start relative z-11">
                     {socialLinks.map((social, index) => (
                      ...
                      >
                         ...
                         <div className="opacity-70 font-THICCCBOI font-regular text-white text-lg max-[1100px]:text-base max-[767px]:text-sm max-[767px]:leading-[18px] text-center tracking-[0] leading-5 whitespace-nowrap">
                           {social.name}
                         </div>
                        </Link>
                     ))}
        ...
        <div className=" w-full  mt-[172px] max-[900px]:mt-[100px]  px-[100px] max-[1100px]:px-[50px] max-[767px]:px-[25px] max-[767px]:mt-[50px] relative z-11">
          <div className="font-THICCCBOI font-normal text-white text-lg max-[1100px]:text-[16px] max-[767px]:text-sm  text-center tracking-[0] leading-[18px]">
